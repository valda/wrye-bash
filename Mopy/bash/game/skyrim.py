...
conditionFunctionData = ( #--0: no param; 1: int param; 2 formid param
    (  0, 'GetWantBlocking', 0, 0, 0, 0, 0),
    (  1, 'GetDistance', 2, 0, 0, 0, 0),
    (  5, 'GetLocked', 0, 0, 0, 0, 0),
    (  6, 'GetPos', 1, 0, 0, 0, 0),
    (  8, 'GetAngle', 1, 0, 0, 0, 0),
    ( 10, 'GetStartingPos', 1, 0, 0, 0, 0),
    ( 11, 'GetStartingAngle', 1, 0, 0, 0, 0),
    ( 12, 'GetSecondsPassed', 0, 0, 0, 0, 0),
    ( 14, 'GetActorValue', 1, 0, 0, 0, 0),
    ( 18, 'GetCurrentTime', 0, 0, 0, 0, 0),
    ( 24, 'GetScale', 0, 0, 0, 0, 0),
    ( 25, 'IsMoving', 0, 0, 0, 0, 0),
    ( 26, 'IsTurning', 0, 0, 0, 0, 0),
    ( 27, 'GetLineOfSight', 2, 0, 0, 0, 0),
    ( 31, 'GetButtonPressed', 0, 0, 0, 0, 0),
    ( 32, 'GetInSameCell', 2, 0, 0, 0, 0),
    ( 35, 'GetDisabled', 0, 0, 0, 0, 0),
    ( 36, 'MenuMode', 1, 0, 0, 0, 0),
    ( 39, 'GetDisease', 0, 0, 0, 0, 0),
    ( 41, 'GetClothingValue', 0, 0, 0, 0, 0),
    ( 42, 'SameFction', 2, 0, 0, 0, 0),
    ( 43, 'SameRace', 2, 0, 0, 0, 0),
    ( 44, 'SameSex', 2, 0, 0, 0, 0),
    ( 45, 'GetDetected', 2, 0, 0, 0, 0),
    ( 46, 'GetDead', 0, 0, 0, 0, 0),
    ( 47, 'GetItemCount', 2, 0, 0, 0, 0),
    ( 48, 'GetGold', 0, 0, 0, 0, 0),
    ( 49, 'GetSleeping', 0, 0, 0, 0, 0),
    ( 50, 'GetTalkedToPC', 0, 0, 0, 0, 0),
    ( 53, 'GetScriptVariable', 2, 1, 0, 0, 0),
    ( 56, 'GetQuestRunning', 2, 0, 0, 0, 0),
    ( 58, 'GetStage', 2, 0, 0, 0, 0),
    ( 59, 'GetStageDone', 2, 1, 0, 0, 0),
    ( 60, 'GetFactionRankDifference', 2, 2, 0, 0, 0),
    ( 61, 'GetAlarmed', 0, 0, 0, 0, 0),
    ( 62, 'IsRaining', 0, 0, 0, 0, 0),
    ( 63, 'GetAttacked', 0, 0, 0, 0, 0),
    ( 64, 'GetIsCreature', 0, 0, 0, 0, 0),
    ( 65, 'GetLockLevel', 0, 0, 0, 0, 0),
    ( 66, 'GetShouldAttack', 2, 0, 0, 0, 0),
    ( 67, 'GetInCell', 2, 0, 0, 0, 0),
    ( 68, 'GetIsClass', 2, 0, 0, 0, 0),
    ( 69, 'GetIsRace', 2, 0, 0, 0, 0),
    ( 70, 'GetIsSex', 2, 0, 0, 0, 0),
    ( 71, 'GetInFaction', 2, 0, 0, 0, 0),
    ( 72, 'GetIsID', 2, 0, 0, 0, 0),
    ( 73, 'GetFactionRank', 2, 0, 0, 0, 0),
    ( 74, 'GetGlobalValue', 2, 0, 0, 0, 0),
    ( 75, 'IsSnowing', 0, 0, 0, 0, 0),
    ( 77, 'GetRandomPercent', 0, 0, 0, 0, 0),
    ( 79, 'GetQuestVvariable', 2, 1, 0, 0, 0),
    ( 80, 'GetLevel', 0, 0, 0, 0, 0),
    ( 81, 'IsRotating', 0, 0, 0, 0, 0),
    ( 83, 'GetLeveledEncounterValue', 1, 0, 0, 0, 0),
    ( 84, 'GetDeadCount', 2, 0, 0, 0, 0),
    ( 91, 'GetIsAlerted', 0, 0, 0, 0, 0),
    ( 98, 'GetPlayerControlsDisabled', 0, 0, 0, 0, 0),
    ( 99, 'GetHeadingAngle', 2, 0, 0, 0, 0),
    (101, 'IsWeaponMagicOut', 0, 0, 0, 0, 0),
    (102, 'IsTorchOut', 0, 0, 0, 0, 0),
    (103, 'IsShieldOut', 0, 0, 0, 0, 0),
    (105, 'IsActionRef', 2, 0, 0, 0, 0),
    (106, 'IsFacingUp', 0, 0, 0, 0, 0),
    (107, 'GetKnockedState', 0, 0, 0, 0, 0),
    (108, 'GetWeaponAnimType', 0, 0, 0, 0, 0),
    (109, 'IsWeaponSkillType', 1, 0, 0, 0, 0),
    (110, 'GetCurrentAIPackage', 0, 0, 0, 0, 0),
    (111, 'IsWaiting', 0, 0, 0, 0, 0),
    (112, 'IsIdlePlaying', 0, 0, 0, 0, 0),
    (116, 'IsIntimidatedbyPlayer', 0, 0, 0, 0, 0),
    (117, 'IsPlayerInRegion', 2, 0, 0, 0, 0),
    (118, 'GetActorAggroRadiusViolated', 0, 0, 0, 0, 0),
    (119, 'GetCrimeKnown', 1, 2, 0, 0, 0),
    (122, 'GetCrime', 2, 1, 0, 0, 0),
    (123, 'IsGreetingPlayer', 0, 0, 0, 0, 0),
    (125, 'IsGuard', 0, 0, 0, 0, 0),
    (127, 'HasBeenEaten', 0, 0, 0, 0, 0),
    (128, 'GetStaminaPercentage', 0, 0, 0, 0, 0),
    (129, 'GetPCIsClass', 2, 0, 0, 0, 0),
    (130, 'GetPCIsRace', 2, 0, 0, 0, 0),
    (131, 'GetPCIsSex', 2, 0, 0, 0, 0),
    (132, 'GetPCInFaction', 2, 0, 0, 0, 0),
    (133, 'SameFactionAsPC', 0, 0, 0, 0, 0),
    (134, 'SameRaceAsPC', 0, 0, 0, 0, 0),
    (135, 'SameSexAsPC', 0, 0, 0, 0, 0),
    (136, 'GetIsReference', 2, 0, 0, 0, 0),
    (141, 'IsTalking', 0, 0, 0, 0, 0),
    (142, 'GetWalkSpeed', 0, 0, 0, 0, 0),
    (143, 'GetCurrentAIProcedure', 0, 0, 0, 0, 0),
    (144, 'GetTrespassWarningLevel', 0, 0, 0, 0, 0),
    (145, 'IsTresPassing', 0, 0, 0, 0, 0),
    (146, 'IsInMyOwnedCell', 0, 0, 0, 0, 0),
    (147, 'GetWindSpeed', 0, 0, 0, 0, 0),
    (148, 'GetCurrentWeatherPercent', 0, 0, 0, 0, 0),
    (149, 'GetIsCurrentWeather', 2, 0, 0, 0, 0),
    (150, 'IsContinuingPackagePCNear', 0, 0, 0, 0, 0),
    (152, 'GetIsCrimeFaction', 2, 0, 0, 0, 0),
    (153, 'CanHaveFlames', 0, 0, 0, 0, 0),
    (154, 'HasFlames', 0, 0, 0, 0, 0),
    (157, 'GetOpenState', 0, 0, 0, 0, 0),
    (159, 'GetSitting', 0, 0, 0, 0, 0),
    (160, 'GetFurnitureMarkerID', 0, 0, 0, 0, 0),
    (161, 'GetIsCurrentPackage', 2, 0, 0, 0, 0),
    (162, 'IsCurrentFurnitureRef', 2, 0, 0, 0, 0),
    (163, 'IsCurrentFurnitureObj', 2, 0, 0, 0, 0),
    (167, 'GetFactionReaction', 2, 2, 0, 0, 0),
    (170, 'GetDayOfWeek', 0, 0, 0, 0, 0),
    (172, 'GetTalkedToPCParam', 2, 0, 0, 0, 0),
    (175, 'IsPCSleeping', 0, 0, 0, 0, 0),
    (176, 'IsPCAMurderer', 0, 0, 0, 0, 0),
    (180, 'HasSameEditorLocAsRef', 2, 2, 0, 0, 0),
    (181, 'HasSameEditorLocAsRefAlias', 2, 2, 0, 0, 0),
    (182, 'GetEquiped', 2, 0, 0, 0, 0),
    (185, 'IsSwimming', 0, 0, 0, 0, 0),
    (188, 'GetPCSleepHours', 0, 0, 0, 0, 0),
    (190, 'GetAmountSoldStolen', 0, 0, 0, 0, 0),
    (192, 'GetIgnoreCrime', 0, 0, 0, 0, 0),
    (193, 'GetPCExpelled', 2, 0, 0, 0, 0),
    (195, 'GetPCFactionMurder', 2, 0, 0, 0, 0),
    (197, 'GetPCEnemyofFaction', 2, 0, 0, 0, 0),
    (199, 'GetPCFactionAttack', 2, 0, 0, 0, 0),
    (203, 'GetDestroyed', 0, 0, 0, 0, 0),
    (205, 'GetActionRef', 0, 0, 0, 0, 0),
    (206, 'GetSelf', 0, 0, 0, 0, 0),
    (207, 'GetContainer', 0, 0, 0, 0, 0),
    (208, 'GetForceRun', 0, 0, 0, 0, 0),
    (210, 'GetForceSneak', 0, 0, 0, 0, 0),
    (214, 'HasMagicEffect', 2, 0, 0, 0, 0),
    (215, 'GetDefaultOpen', 0, 0, 0, 0, 0),
    (219, 'GetAnimAction', 0, 0, 0, 0, 0),
    (223, 'IsSpellTarget', 2, 0, 0, 0, 0),
    (224, 'GetVATSMode', 0, 0, 0, 0, 0),
    (225, 'GetPersuationNumber', 0, 0, 0, 0, 0),
    (226, 'GetVampireFeed', 0, 0, 0, 0, 0),
    (227, 'GetCannibal', 0, 0, 0, 0, 0),
    (228, 'GetIsClassDefault', 2, 0, 0, 0, 0),
    (229, 'GetClassDefaultMatch', 0, 0, 0, 0, 0),
    (230, 'GetInCellParam', 2, 2, 0, 0, 0),
    (232, 'GetCombatTarget', 0, 0, 0, 0, 0),
    (233, 'GetPackageTarget', 0, 0, 0, 0, 0),
    (235, 'GetVatsTargetHeight', 0, 0, 0, 0, 0),
    (237, 'GetIsGhost', 0, 0, 0, 0, 0),
    (242, 'GetUnconscious', 0, 0, 0, 0, 0),
    (244, 'GetRestrained', 0, 0, 0, 0, 0),
    (246, 'GetIsUsedItem', 2, 0, 0, 0, 0),
    (247, 'GetIsUsedItemType', 2, 0, 0, 0, 0),
    (248, 'IsScenePlaying', 2, 0, 0, 0, 0),
    (249, 'IsInDialogWithPlayer', 0, 0, 0, 0, 0),
    (250, 'GetLocationCleared', 2, 0, 0, 0, 0),
    (254, 'GetIsPlayableRace', 0, 0, 0, 0, 0),
    (255, 'GetOffersServicesNow', 0, 0, 0, 0, 0),
    (256, 'GetGameSetting', 1, 0, 0, 0, 0),
    (258, 'HasAssociationType', 2, 2, 0, 0, 0),
    (259, 'HasFamilyRelationship', 2, 0, 0, 0, 0),
    (261, 'HasParentRelationship', 2, 0, 0, 0, 0),
    (262, 'IsWarningAbout', 2, 0, 0, 0, 0),
    (263, 'IsWeaponOut', 0, 0, 0, 0, 0),
    (264, 'HasSpell', 2, 0, 0, 0, 0),
    (265, 'IsTimePassing', 0, 0, 0, 0, 0),
    (266, 'IsPleasant', 0, 0, 0, 0, 0),
    (267, 'IsCloudy', 0, 0, 0, 0, 0),
    (274, 'IsSmallBump', 0, 0, 0, 0, 0),
    (275, 'GetParentRef', 0, 0, 0, 0, 0),
    (277, 'GetBaseActorValue', 1, 0, 0, 0, 0),
    (278, 'IsOwner', 2, 0, 0, 0, 0),
    (280, 'IsCellOwner', 2, 2, 0, 0, 0),
    (282, 'IsHorseStolen', 0, 0, 0, 0, 0),
    (285, 'IsLeftUp', 0, 0, 0, 0, 0),
    (286, 'IsSneaking', 0, 0, 0, 0, 0),
    (287, 'IsRunning', 0, 0, 0, 0, 0),
    (288, 'GetFriendHit', 0, 0, 0, 0, 0),
    (289, 'IsInCombat', 1, 0, 0, 0, 0),
    (296, 'IsAnimPlaying', 2, 0, 0, 0, 0),
    (300, 'IsInInterior', 0, 0, 0, 0, 0),
    (303, 'IsActorsAIOff', 0, 0, 0, 0, 0),
    (304, 'IsWaterObject', 0, 0, 0, 0, 0),
    (305, 'GetPlayerAction', 0, 0, 0, 0, 0),
    (306, 'IsActorUsingATorch', 0, 0, 0, 0, 0),
    (309, 'IsXBox', 0, 0, 0, 0, 0),
    (310, 'GetInWorldspace', 2, 0, 0, 0, 0),
    (312, 'GetPCMiscStat', 1, 0, 0, 0, 0),
    (313, 'GetPairedAnimation', 0, 0, 0, 0, 0),
    (314, 'IsActorAVictim', 0, 0, 0, 0, 0),
    (315, 'GetTotalPersuationNumber', 0, 0, 0, 0, 0),
    (318, 'GetIdleDoneOnce', 0, 0, 0, 0, 0),
    (320, 'GetNoRumors', 0, 0, 0, 0, 0),
    (323, 'GetCombatState', 0, 0, 0, 0, 0),
    (325, 'GetWithinPackageLocation', 2, 0, 0, 0, 0),
    (327, 'IsRidingHorse', 0, 0, 0, 0, 0),
    (329, 'IsFleeing', 0, 0, 0, 0, 0),
    (332, 'IsInDangerousWater', 0, 0, 0, 0, 0),
    (338, 'GetIgnoreFriendlyHits', 0, 0, 0, 0, 0),
    (339, 'IsPlayersLastRiddenHorse', 0, 0, 0, 0, 0),
    (353, 'IsActor', 0, 0, 0, 0, 0),
    (354, 'IsEssential', 0, 0, 0, 0, 0),
    (358, 'IsPlayerMovingIntoNewSpace', 0, 0, 0, 0, 0),
    (359, 'GetInCurrentLoc', 2, 0, 0, 0, 0),
    (360, 'GetInCurrentLocAlias', 2, 0, 0, 0, 0),
    (361, 'GetTimeDead', 0, 0, 0, 0, 0),
    (362, 'HasLinkedRef', 2, 0, 0, 0, 0),
    (363, 'GetLinkedRef', 2, 0, 0, 0, 0),
    (365, 'IsChild', 0, 0, 0, 0, 0),
    (366, 'GetStolenItemValueNoCrime', 2, 0, 0, 0, 0),
    (367, 'GetLastPlayerAction', 0, 0, 0, 0, 0),
    (368, 'IsPlayerActionActive', 1, 0, 0, 0, 0),
    (370, 'IsTalkingActivatorActor', 2, 0, 0, 0, 0),
    (372, 'IsInList', 2, 0, 0, 0, 0),
    (373, 'GetStolenItemValue', 2, 0, 0, 0, 0),
    (375, 'GetCrimeGoldViolent', 2, 0, 0, 0, 0),
    (376, 'GetCrimeGoldNonviolent', 2, 0, 0, 0, 0),
    (378, 'HasShout', 2, 0, 0, 0, 0),
    (381, 'GetHasNote', 2, 0, 0, 0, 0),
    (387, 'GetObjectiveFailed', 2, 1, 0, 0, 0),
    (390, 'GetHitLocation', 0, 0, 0, 0, 0),
    (391, 'IsPC1stPerson', 0, 0, 0, 0, 0),
    (396, 'GetCauseofDeath', 0, 0, 0, 0, 0),
    (397, 'IsLimbGone', 1, 0, 0, 0, 0),
    (398, 'IsWeaponInList', 2, 0, 0, 0, 0),
    (402, 'IsBribedbyPlayer', 0, 0, 0, 0, 0),
    (403, 'GetRelationshipRank', 2, 0, 0, 0, 0),
    (407, 'GetVATSValue', 1, 1, 0, 0, 0),
    (408, 'IsKiller', 2, 0, 0, 0, 0),
    (409, 'IsKillerObject', 2, 0, 0, 0, 0),
    (410, 'GetFactionCombatReaction', 2, 2, 0, 0, 0),
    (414, 'Exists', 2, 0, 0, 0, 0),
    (415, 'GetGroupMemberCount', 0, 0, 0, 0, 0),
    (416, 'GetGroupTargetCount', 0, 0, 0, 0, 0),
    (419, 'GetObjectiveCompleted', 2, 1, 0, 0, 0),
    (420, 'GetObjectiveDisplayed', 2, 1, 0, 0, 0),
    (425, 'GetIsFormType', 2, 0, 0, 0, 0),
    (426, 'GetIsVoiceType', 2, 0, 0, 0, 0),
    (427, 'GetPlantedExplosive', 0, 0, 0, 0, 0),
    (429, 'IsScenePackageRunning', 0, 0, 0, 0, 0),
    (430, 'GetHealthPercentage', 0, 0, 0, 0, 0),
    (432, 'GetIsObjectType', 2, 0, 0, 0, 0),
    (434, 'GetDialogEmotion', 0, 0, 0, 0, 0),
    (435, 'GetDialogEmotionValue', 0, 0, 0, 0, 0),
    (437, 'GetIsCreatureType', 1, 0, 0, 0, 0),
    (444, 'GetInCurrentLocFormList', 2, 0, 0, 0, 0),
    (445, 'GetInZone', 2, 0, 0, 0, 0),
    (446, 'GetVelocity', 1, 0, 0, 0, 0),
    (447, 'GetGraphVariableFloat', 1, 0, 0, 0, 0),
    (448, 'HasPerk', 2, 0, 0, 0, 0),
    (449, 'GetFactionRelation', 2, 0, 0, 0, 0),
    (450, 'IsLastIdlePlayed', 2, 0, 0, 0, 0),
    (453, 'GetPlayerTeammate', 0, 0, 0, 0, 0),
    (458, 'GetActorCrimePlayerEnemy', 0, 0, 0, 0, 0),
    (459, 'GetCrimeGold', 2, 0, 0, 0, 0),
    (462, 'GetPlayerGrabbedRef', 0, 0, 0, 0, 0),
    (463, 'IsPlayerGrabbedRef', 2, 0, 0, 0, 0),
    (465, 'GetKeywordItemCount', 2, 0, 0, 0, 0),
    (467, 'GetBroadcastState', 0, 0, 0, 0, 0),
    (470, 'GetDestructionStage', 0, 0, 0, 0, 0),
    (473, 'GetIsAlignment', 2, 0, 0, 0, 0),
    (476, 'IsProtected', 0, 0, 0, 0, 0),
    (477, 'GetThreatRatio', 2, 0, 0, 0, 0),
    (479, 'GetIsUsedItemEquipType', 2, 0, 0, 0, 0),
    (480, 'GetPlayerName', 0, 0, 0, 0, 0),
    (487, 'IsCarryable', 0, 0, 0, 0, 0),
    (488, 'GetConcussed', 0, 0, 0, 0, 0),
    (491, 'GetMapMarkerVisible', 0, 0, 0, 0, 0),
    (494, 'GetPermanentActorValue', 1, 0, 0, 0, 0),
    (495, 'GetKillingBlowLimb', 0, 0, 0, 0, 0),
    (497, 'CanPayCrimeGold', 2, 0, 0, 0, 0),
    (499, 'GetDaysInJail', 0, 0, 0, 0, 0),
    (500, 'EPAlchemyGetMakingPoison', 0, 0, 0, 0, 0),
    (501, 'EPAlchemyEffectHasKeyword', 2, 0, 0, 0, 0),
    (503, 'GetAllowWorldInteractions', 0, 0, 0, 0, 0),
    (508, 'GetLastHitCritical', 0, 0, 0, 0, 0),
    (513, 'IsCombatTarget', 2, 0, 0, 0, 0),
    (515, 'GetVATSRightAreaFree', 2, 0, 0, 0, 0),
    (516, 'GetVATSLeftAreaFree', 2, 0, 0, 0, 0),
    (517, 'GetVATSBackAreaFree', 2, 0, 0, 0, 0),
    (518, 'GetVATSFrontAreaFree', 2, 0, 0, 0, 0),
    (519, 'GetIsLockBroken', 0, 0, 0, 0, 0),
    (520, 'IsPS3', 0, 0, 0, 0, 0),
    (521, 'IsWin32', 0, 0, 0, 0, 0),
    (522, 'GetVATSRightTargetVisible', 2, 0, 0, 0, 0),
    (523, 'GetVATSLeftTargetVisible', 2, 0, 0, 0, 0),
    (524, 'GetVATSBackTargetVisible', 2, 0, 0, 0, 0),
    (525, 'GetVATSFrontTargetVisible', 2, 0, 0, 0, 0),
    (528, 'IsInCriticalStage', 2, 0, 0, 0, 0),
    (530, 'GetXPForNextLevel', 0, 0, 0, 0, 0),
    (533, 'GetInfamy', 2, 0, 0, 0, 0),
    (534, 'GetInfamyViolent', 2, 0, 0, 0, 0),
    (535, 'GetInfamyNonViolent', 2, 0, 0, 0, 0),
    (543, 'GetQuestCompleted', 2, 0, 0, 0, 0),
    (547, 'IsGoreDisabled', 0, 0, 0, 0, 0),
    (550, 'IsSceneActionComplete', 2, 1, 0, 0, 0),
    (552, 'GetSpellUsageNum', 2, 0, 0, 0, 0),
    (554, 'GetActorsInHigh', 0, 0, 0, 0, 0),
    (555, 'HasLoaded3D', 0, 0, 0, 0, 0),
    (559, 'IsImageSpaceActive', 2, 0, 0, 0, 0),
    (560, 'HasKeyword', 2, 0, 0, 0, 0),
    (561, 'HasRefType', 2, 0, 0, 0, 0),
    (562, 'LocationHasKeyword', 2, 0, 0, 0, 0),
    (563, 'LocationHasRefType', 2, 0, 0, 0, 0),
    (565, 'GetIsEditorLocation', 2, 0, 0, 0, 0),
    (566, 'GetIsAliasRef', 2, 0, 0, 0, 0),
    (567, 'GetIsEditorLocAlias', 2, 0, 0, 0, 0),
    (568, 'IsSprinting', 0, 0, 0, 0, 0),
    (569, 'IsBlocking', 0, 0, 0, 0, 0),
    (570, 'HasEquippedSpell', 2, 0, 0, 0, 0),
    (571, 'GetCurrentCastingType', 2, 0, 0, 0, 0),
    (572, 'GetCurrentDeliveryType', 2, 0, 0, 0, 0),
    (574, 'GetAttackState', 0, 0, 0, 0, 0),
    (575, 'GetAliasedRef', 2, 0, 0, 0, 0),
    (576, 'GetEventData', 2, 2, 0, 0, 0),
    (577, 'IsCloserToAThanB', 2, 2, 0, 0, 0),
    (579, 'GetEquippedShout', 2, 0, 0, 0, 0),
    (580, 'IsBleedingOut', 0, 0, 0, 0, 0),
    (584, 'GetRelativeAngle', 2, 1, 0, 0, 0),
    (589, 'GetMovementDirection', 0, 0, 0, 0, 0),
    (590, 'IsInScene', 0, 0, 0, 0, 0),
    (591, 'GetRefTypeDeadCount', 2, 2, 0, 0, 0),
    (592, 'GetRefTypeAliveCount', 2, 2, 0, 0, 0),
    (594, 'GetIsFlying', 0, 0, 0, 0, 0),
    (595, 'IsCurrentSpell', 2, 2, 0, 0, 0),
    (596, 'SpellHasKeyword', 2, 2, 0, 0, 0),
    (597, 'GetEquippedItemType', 2, 0, 0, 0, 0),
    (598, 'GetLocationAliasCleared', 2, 0, 0, 0, 0),
    (600, 'GetLocAliasRefTypeDeadCount', 2, 2, 0, 0, 0),
    (601, 'GetLocAliasRefTypeAliveCount', 2, 2, 0, 0, 0),
    (602, 'IsWardState', 2, 0, 0, 0, 0),
    (603, 'IsInSameCurrentLocAsRef', 2, 2, 0, 0, 0),
    (604, 'IsInSameCurrentLocAsRefAlias', 2, 2, 0, 0, 0),
    (605, 'LocAliasIsLocation', 2, 2, 0, 0, 0),
    (606, 'GetKeywordDataForLocation', 2, 2, 0, 0, 0),
    (608, 'GetKeywordDataForAlias', 2, 2, 0, 0, 0),
    (610, 'LocAliasHasKeyword', 2, 2, 0, 0, 0),
    (611, 'IsNullPackageData', 1, 0, 0, 0, 0),
    (612, 'GetNumericPackageData', 1, 0, 0, 0, 0),
    (613, 'IsFurnitureAnimType', 2, 0, 0, 0, 0),
    (614, 'IsFurnitureEntryType', 2, 0, 0, 0, 0),
    (615, 'GetHighestRelationshipRank', 0, 0, 0, 0, 0),
    (616, 'GetLowestRelationshipRank', 0, 0, 0, 0, 0),
    (617, 'HasAssociationTypeAny', 2, 0, 0, 0, 0),
    (618, 'HasFamilyRelationshipAny', 0, 0, 0, 0, 0),
    (619, 'GetPathingTargetOffset', 1, 0, 0, 0, 0),
    (620, 'GetPathingTargetAngleOffset', 1, 0, 0, 0, 0),
    (621, 'GetPathingTargetSpeed', 0, 0, 0, 0, 0),
    (622, 'GetPathingTargetSpeedAngle', 1, 0, 0, 0, 0),
    (623, 'GetMovementSpeed', 0, 0, 0, 0, 0),
    (624, 'GetInContainer', 2, 0, 0, 0, 0),
    (625, 'IsLocationLoaded', 2, 0, 0, 0, 0),
    (626, 'IsLocAliasLoaded', 2, 0, 0, 0, 0),
    (627, 'IsDualCasting', 0, 0, 0, 0, 0),
    (629, 'GetVMQuestVariable', 2, 1, 0, 0, 0),
    (630, 'GetVMScriptVariable', 2, 1, 0, 0, 0),
    (631, 'IsEnteringInteractionQuick', 0, 0, 0, 0, 0),
    (632, 'IsCasting', 0, 0, 0, 0, 0),
    (633, 'GetFlyingState', 0, 0, 0, 0, 0),
    (635, 'IsInFavorState', 0, 0, 0, 0, 0),
    (636, 'HasTwoHandedWeaponEquipped', 0, 0, 0, 0, 0),
    (637, 'IsExitingInstant', 0, 0, 0, 0, 0),
    (638, 'IsInFriendStatewithPlayer', 0, 0, 0, 0, 0),
    (639, 'GetWithinDistance', 2, 1, 0, 0, 0),
    (640, 'GetActorValuePercent', 1, 0, 0, 0, 0),
    (641, 'IsUnique', 0, 0, 0, 0, 0),
    (642, 'GetLastBumpDirection', 0, 0, 0, 0, 0),
    (644, 'IsInFurnitureState', 2, 0, 0, 0, 0),
    (645, 'GetIsInjured', 0, 0, 0, 0, 0),
    (646, 'GetIsCrashLandRequest', 0, 0, 0, 0, 0),
    (647, 'GetIsHastyLandRequest', 0, 0, 0, 0, 0),
    (650, 'IsLinkedTo', 2, 2, 0, 0, 0),
    (651, 'GetKeywordDataForCurrentLocation', 2, 0, 0, 0, 0),
    (652, 'GetInSharedCrimeFaction', 2, 0, 0, 0, 0),
    (653, 'GetBribeAmount', 0, 0, 0, 0, 0),
    (654, 'GetBribeSuccess', 0, 0, 0, 0, 0),
    (655, 'GetIntimidateSuccess', 0, 0, 0, 0, 0),
    (656, 'GetArrestedState', 0, 0, 0, 0, 0),
    (657, 'GetArrestingActor', 0, 0, 0, 0, 0),
    (659, 'EPTemperingItemIsEnchanted', 0, 0, 0, 0, 0),
    (660, 'EPTemperingItemHasKeyword', 2, 0, 0, 0, 0),
    (661, 'GetReceivedGiftValue', 0, 0, 0, 0, 0),
    (662, 'GetGiftGivenValue', 0, 0, 0, 0, 0),
    (664, 'GetReplacedItemType', 2, 0, 0, 0, 0),
    (672, 'IsAttacking', 0, 0, 0, 0, 0),
    (673, 'IsPowerAttacking', 0, 0, 0, 0, 0),
    (674, 'IsLastHostileActor', 0, 0, 0, 0, 0),
    (675, 'GetGraphVariableInt', 1, 0, 0, 0, 0),
    (676, 'GetCurrentShoutVariation', 0, 0, 0, 0, 0),
    (678, 'ShouldAttackKill', 2, 0, 0, 0, 0),
    (680, 'GetActivationHeight', 0, 0, 0, 0, 0),
    (681, 'EPModSkillUsage_IsAdvancedSkill', 1, 0, 0, 0, 0),
    (682, 'WornHasKeyword', 2, 0, 0, 0, 0),
    (683, 'GetPathingCurrentSpeed', 0, 0, 0, 0, 0),
    (684, 'GetPathingCurrentSpeedAngle', 1, 0, 0, 0, 0),
    (691, 'EPModSkillUsage_AdvancedObjectHasKeyword', 2, 0, 0, 0, 0),
    (692, 'EPModSkillUsage_IsAdvancedAction', 2, 0, 0, 0, 0),
    (693, 'EPMagic_SpellHasKeyword', 2, 0, 0, 0, 0),
    (694, 'GetNoBleedoutRecovery', 0, 0, 0, 0, 0),
    (696, 'EPMagic_SpellHasSkill', 1, 0, 0, 0, 0),
    (697, 'IsAttackType', 2, 0, 0, 0, 0),
    (698, 'IsAllowedToFly', 0, 0, 0, 0, 0),
    (699, 'HasMagicEffectKeyword', 2, 0, 0, 0, 0),
    (700, 'IsCommandedActor', 0, 0, 0, 0, 0),
    (701, 'IsStaggered', 0, 0, 0, 0, 0),
    (702, 'IsRecoiling', 0, 0, 0, 0, 0),
    (703, 'IsExitingInteractionQuick', 0, 0, 0, 0, 0),
    (704, 'IsPathing', 0, 0, 0, 0, 0),
    (705, 'GetShouldHelp', 2, 0, 0, 0, 0),
    (706, 'HasBoundWeaponEquipped', 2, 0, 0, 0, 0),
    (707, 'GetCombatTargetHasKeyword', 2, 0, 0, 0, 0),
    (709, 'GetCombatGroupMemberCount', 0, 0, 0, 0, 0),
    (710, 'IsIgnoringCombat', 0, 0, 0, 0, 0),
    (711, 'GetLightLevel', 0, 0, 0, 0, 0),
    (713, 'SpellHasCastingPerk', 2, 0, 0, 0, 0),
    (714, 'IsBeingRidden', 0, 0, 0, 0, 0),
    (715, 'IsUndead', 0, 0, 0, 0, 0),
    (716, 'GetRealHoursPassed', 0, 0, 0, 0, 0),
    (718, 'IsUnlockedDoor', 0, 0, 0, 0, 0),
    (719, 'IsHostileToActor', 2, 0, 0, 0, 0),
    (720, 'GetTargetHeight', 0, 0, 0, 0, 0),
    (721, 'IsPoison', 0, 0, 0, 0, 0),
    (722, 'WornApparelHasKeywordCount', 2, 0, 0, 0, 0),
    (723, 'GetItemHealthPercent', 0, 0, 0, 0, 0),
    (724, 'EffectWasDualCast', 0, 0, 0, 0, 0),
    (725, 'GetKnockStateEnum', 0, 0, 0, 0, 0),
    )
